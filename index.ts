...
import { Errors, PostgresError } from "./errors"
import largeObject from "./large"
import { CLOSE, Query } from "./query"
...
function parseOptions(a: string | { shared: any }, b) {
	if (a && a.shared)
		return a
